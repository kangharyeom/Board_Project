package company.board_project.domain.list.team.service;

import company.board_project.domain.apply.team.entity.TeamApply;
import company.board_project.domain.apply.team.service.TeamApplyService;
...
import company.board_project.domain.list.team.repository.TeamMemberListRepository;
...
public class TeamMemberListService {
    ...
    public TeamMemberList createTeamMemberList(
            TeamMemberList teamMemberList, Long userId, Long teamId, Long TeamApplyId) {
        ...
        teamMemberList.setTeamApply(teamApply);
