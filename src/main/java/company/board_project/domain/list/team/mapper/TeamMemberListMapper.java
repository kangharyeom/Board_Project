package company.board_project.domain.list.team.mapper;
...
import company.board_project.domain.list.team.dto.TeamMemberListResponseListDto;
...
public interface TeamMemberListMapper {
    ...
    default TeamMemberListResponseDto teamMemberListToTeamMemberListResponse(TeamMemberList teamMemberList){
        ...
        TeamApply teamApply = teamMemberList.getTeamApply();
