package company.board_project.domain.list.league.service;
...
import company.board_project.domain.list.league.repository.LeagueListRepository;
...
public class LeagueListService {
    ...
    public LeagueList createLeagueList(
            LeagueList leagueList, Long userId, Long teamId, Long leagueId, Long leagueApplyId) {
        ...
        leagueList.setLeagueApply(leagueApply);
