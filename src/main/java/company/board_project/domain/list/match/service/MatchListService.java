package company.board_project.domain.list.match.service;

import company.board_project.domain.apply.match.entity.MatchApply;
import company.board_project.domain.apply.match.service.MatchApplyService;
import company.board_project.domain.list.match.repository.MatchListRepository;
...
public class MatchListService {
    ...
    public MatchList createMatchList(
            MatchList matchList, Long awayTeamUserId,Long matchApplyId, Long awayTeamId, Long matchId) {
        ...
        matchList.setMatchApply(matchApply);
